...
class ExtraGrievanceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $extraData = [
            ...
            [
                'subject' => 'AWS Cloud Cost Spike Due to Unused Resources',
                'description' => 'Our AWS dev environment bill spiked by $4,000 this month. I suspect someone left a GPU cluster running. We need to audit resources immediately.',
                'category' => 'Technical/IT problems',
                'priority' => 'Medium',
                'status' => 'Submitted',
                'sentiment_label' => 'Concerned',
            ...
            [
                'subject' => 'Intellectual Property Ownership in Contract Clause',
                'description' => 'The freelance developer contract we used for the mobile app has an ambiguous IP assignment clause. We need a legal review before our Series A due diligence begins.',
                'category' => 'Funding/legal issues',
                'priority' => 'High',
                'status' => 'Under Review',
                'sentiment_label' => 'Critical',
            ...
            [
                'subject' => 'Maternity/Paternity Leave Policy Update Request',
                'description' => 'Requesting the HR team to publish a clear handbook on parenting leave benefits. The current guidelines are scattered across three different Slack posts.',
                'category' => 'HR issues',
                'priority' => 'Low',
                'status' => 'Resolved',
                'sentiment_label' => 'Calm',
            ...
            [
                'subject' => 'Intermittent WiFi Outage in Conference Room B',
                'description' => 'The smart screen in Conference Room B keeps disconnecting from the WiFi during client presentations. We need to install an ethernet drop.',
                'category' => 'Technical/IT problems',
                'priority' => 'Low',
                'status' => 'Resolved',
                'sentiment_label' => 'Calm',
            ...
            [
                'subject' => 'Ambiguous Vesting Schedule in ESOP Grant',
                'description' => 'My ESOP dashboard shows a standard 1-year cliff, but my offer letter specified an immediate vest for the first 10% of options. Please correct this.',
                'category' => 'Funding/legal issues',
                'priority' => 'Medium',
                'status' => 'Submitted',
                'sentiment_label' => 'Concerned',
            ...
            [
                'subject' => 'Gender Pay Gap Audit Request',
                'description' => 'I request an anonymous audit of salary bands across engineering teams. Several female colleagues have raised concerns about inconsistent compensation for similar experience levels.',
                'category' => 'HR issues',
                'priority' => 'High',
                'status' => 'Submitted',
                'sentiment_label' => 'Concerned',

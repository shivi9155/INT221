...
const LandingPage = () => {
    ...
    return (
        <div className={`min-h-screen font-sans transition-colors duration-300 ${isDarkMode ? 'bg-[#0a0a0a] text-white' : 'bg-white text-[#0a0a0a]'}`}>
            {/* Navigation */}
            <nav className={`fixed top-0 w-full z-50 backdrop-blur-md transition-colors duration-300 ${isDarkMode ? 'border-white/5 bg-[#0a0a0a]/80' : 'border-black/5 bg-white/80'}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <div className="flex items-center gap-3">
                                <a href="/login" className={`px-5 py-2.5 text-sm font-bold rounded-xl border transition-all ${isDarkMode ? 'border-white/10 hover:bg-white/5' : 'border-black/10 hover:bg-black/5'}`}>Sign in</a>
                        ...
                        <div className="md:hidden flex items-center gap-4">
                            <button onClick={toggleTheme} className="p-2" title={isDarkMode ? 'Switch to light mode' : 'Switch to dark mode'}>
                                {isDarkMode ? <Sun className="w-5 h-5 text-[#ff6b00]" /> : <Moon className="w-5 h-5 text-[#ff6b00]" />}
                            </button>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div 
                        ...
                        className={`fixed top-20 w-full z-40 md:hidden transition-colors duration-300 ${isDarkMode ? 'bg-[#0a0a0a] border-white/5' : 'bg-white border-black/5'} border-b`}
                    >
                        <div className="px-4 py-6 space-y-4">
                            ...
                            <div className="pt-4 flex flex-col gap-3">
                                <a href="/login" className={`w-full py-3 text-center rounded-xl border transition-all ${isDarkMode ? 'border-white/10 hover:bg-white/5' : 'border-black/10 hover:bg-black/5'}`}>Sign in</a>
                                <a href="/register" className="w-full py-3 text-center rounded-xl bg-[#ff6b00] text-black font-bold hover:bg-[#ff8533] transition-all">Get started</a>
                            </div>
                        </div>
                    </motion.div>
                )}
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <div className="space-y-8">
                            ...
                            <motion.p variants={itemVariants} className={`text-lg lg:text-xl leading-relaxed max-w-xl ${isDarkMode ? 'text-white/60' : 'text-black/60'}`}>
                            ...
                            <motion.div variants={itemVariants} className={`grid grid-cols-3 gap-6 pt-8 border-t ${isDarkMode ? 'border-white/5' : 'border-black/5'}`}>
                                <div>
                                    <h3 className="text-2xl font-bold">4-Stage</h3>
                                    <p className={`text-xs uppercase tracking-widest font-bold mt-1 ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>Workflow</p>
                                </div>
                                <div>
                                    <h3 className="text-2xl font-bold">SLA+AI</h3>
                                    <p className={`text-xs uppercase tracking-widest font-bold mt-1 ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>Smart Priority</p>
                                </div>
                                <div>
                                    <h3 className="text-2xl font-bold">360°</h3>
                                    <p className={`text-xs uppercase tracking-widest font-bold mt-1 ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>Analytics</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        >
                            ...
                            <div className={`relative rounded-3xl border p-8 transition-colors duration-300 ${isDarkMode ? 'bg-[#141414] border-white/10' : 'bg-gray-50 border-black/10'}`}>
                                <div className="flex justify-between items-center mb-8">
                                    ...
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300 ${isDarkMode ? 'bg-white/5' : 'bg-black/5'}`}>
                                        <div className="w-2 h-2 rounded-full bg-[#ff6b00]" />
                                    </div>
                                </div>

                                <div className={`p-6 rounded-2xl border transition-colors duration-300 ${isDarkMode ? 'bg-[#0a0a0a] border-white/5' : 'bg-white shadow-xl border-black/5'}`}>
                                    <div className="flex justify-between items-start mb-4">
                                        <span className={`text-xs font-mono ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>RX-2026-AI82K</span>
                                    ...
                                    <p className={`text-sm leading-relaxed mb-6 ${isDarkMode ? 'text-white/50' : 'text-black/50'}`}>Classifier recommends HR review. SLA deadline: 24h. Escalation triggered if no progress.</p>
                                    
                                    <div className="space-y-3">
                                        {[
                                            { label: 'Status', value: 'Under Review', color: 'text-orange-400' },
                                            { label: 'Sentiment', value: 'Critical', color: 'text-red-400' },
                                            { label: 'Assigned', value: 'Moderator queue', color: isDarkMode ? 'text-white' : 'text-black' }
                                        ].map((stat, i) => (
                                            <div key={i} className={`flex justify-between items-center py-2 border-t ${isDarkMode ? 'border-white/5' : 'border-black/5'}`}>
                                                <span className={`text-xs ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>{stat.label}</span>
            ...
            {/* Features Section */}
            <section id="features" className={`py-24 px-4 transition-colors duration-300 ${isDarkMode ? 'bg-[#0f0f0f]' : 'bg-gray-50'}`}>
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                        <h2 className="text-4xl font-bold">Built for serious startup operations</h2>
                        <p className={`text-lg ${isDarkMode ? 'text-white/50' : 'text-black/50'}`}>Beyond a basic form. Structured intake, coordinated action, and visible timelines.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div 
                                key={i}
                                whileHover={{ y: -10 }}
                                className={`p-8 rounded-3xl border transition-colors duration-300 ${isDarkMode ? 'bg-[#141414] border-white/5' : 'bg-white shadow-lg border-black/5'}`}
                            >
                                <div className="w-14 h-14 rounded-2xl bg-[#ff6b00]/10 flex items-center justify-center text-[#ff6b00] mb-6">
                                    {feature.icon}
                                </div>
                                <h3 className="text-xl font-bold mb-3">{feature.title}</h3>
                                <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-white/50' : 'text-black/50'}`}>{feature.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                        <div className="space-y-4">
                            ...
                            <p className={isDarkMode ? 'text-white/50' : 'text-black/50'}>A simple, transparent path for every user.</p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-5 gap-4">
                        {[
                            ...
                            <div key={i} className={`p-6 rounded-2xl border transition-colors duration-300 ${isDarkMode ? 'bg-[#141414] border-white/5' : 'bg-gray-50 border-black/5'}`}>
                                ...
                                <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>{step.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Footer */}
            <footer className={`py-12 border-t transition-colors duration-300 ${isDarkMode ? 'border-white/5' : 'border-black/5'}`}>
                <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <p className={`text-sm ${isDarkMode ? 'text-white/40' : 'text-black/40'}`}>© 2026 ResolveX platform for startups. Built with React & Tailwind.</p>
                    <div className="flex gap-6">
                        <a href="#" className={`transition-colors ${isDarkMode ? 'text-white/40 hover:text-[#ff6b00]' : 'text-black/40 hover:text-[#ff6b00]'}`}>Twitter</a>
                        <a href="#" className={`transition-colors ${isDarkMode ? 'text-white/40 hover:text-[#ff6b00]' : 'text-black/40 hover:text-[#ff6b00]'}`}>GitHub</a>
                    </div>
                </div>
            </footer>
        </div>

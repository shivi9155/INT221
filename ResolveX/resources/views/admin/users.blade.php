...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['admin_count'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['moderator_count'] }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <form method="GET" class="flex flex-wrap gap-4">
            ...
            <a href="{{ route('admin.users') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                🔄 Clear
            </a>
        </form>
    </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Manage user roles and account status</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Grievances</th>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button onclick="viewUserDetails('{{ $user->id }}')"
                                            class="text-blue-600 hover:text-blue-900">👁️ View</button>
                                    @if($user->role !== 'admin')
        ...
        document.getElementById('userDetails').innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900">User</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Total Grievances</label>
                    <p class="mt-1 text-sm text-gray-900">5</p>
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700">Recent Activity</label>
                    <div class="mt-1 space-y-2">
                        <p class="text-sm text-gray-600">• Submitted grievance #GRV-001 2 days ago</p>
                        <p class="text-sm text-gray-600">• Updated grievance #GRV-002 1 week ago</p>
                    </div>
                </div>
            </div>
        `;
